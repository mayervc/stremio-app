    ...
    >
      <View style={styles.recentSearchPosterContainer}>
        {item.image ? (
          ...
          <View style={[styles.recentSearchPoster, styles.placeholderImage]}>
            <Ionicons name='image-outline' size={48} color='#666666' />
          </View>
        )}
        <View style={styles.recentSearchPlayOverlay}>
          <Ionicons name='play' size={16} color='#FFFFFF' />
        </View>
      </View>
      <ThemedText style={styles.recentSearchCardTitle} numberOfLines={2}>
        {item.title}
      </ThemedText>
    </TouchableOpacity>
  )
